...
class CitasControllerTest < ActionController::TestCase
  ...
  test "should create cita" do
    assert_difference('Cita.count') do
      post :create, cita: { especialista_id: @cita.especialista_id, estatus: @cita.estatus, fecha: @cita.fecha, paciente_id: @cita.paciente_id }
    end
  ...
  test "should update cita" do
    patch :update, id: @cita, cita: { especialista_id: @cita.especialista_id, estatus: @cita.estatus, fecha: @cita.fecha, paciente_id: @cita.paciente_id }
    assert_redirected_to cita_path(assigns(:cita))
  end
