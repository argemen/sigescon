...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { apellidos: @paciente.apellidos, cedula: @paciente.cedula, direccion: @paciente.direccion, nombres: @paciente.nombres, telefono: @paciente.telefono }
    end
  ...
  test "should update paciente" do
    patch :update, id: @paciente, paciente: { apellidos: @paciente.apellidos, cedula: @paciente.cedula, direccion: @paciente.direccion, nombres: @paciente.nombres, telefono: @paciente.telefono }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
